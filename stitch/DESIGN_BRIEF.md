...
- Runtime Ping Converter Rootfix turns the user's request into a directly usable web workflow. The first experience must be the actual web product behavior, not a marketing landing page or placeholder demo.
- - FR-001: Build a tiny single-page status tile app called Runtime Ping Converter Rootfix. It should show three status cards, a live timestamp, and one reset button. Keep it simple for pipeline testing. REPO: /Users/setrox/projects/runtime-ping-converter-rootfix-20260629-230703. Frontend port: 3623
...
- Record Operations - Runtime Ping Converter Rootfix
- Record Editor - Runtime Ping Converter Rootfix
- Pipeline Board - Runtime Ping Converter Rootfix
- Insights - Runtime Ping Converter Rootfix

## SCREEN_SPECS
SCREEN_SPEC_1:
- exact_screen_title: Record Operations - Runtime Ping Converter Rootfix
...
SCREEN_SPEC_2:
- exact_screen_title: Record Editor - Runtime Ping Converter Rootfix
...
SCREEN_SPEC_3:
- exact_screen_title: Pipeline Board - Runtime Ping Converter Rootfix
...
SCREEN_SPEC_4:
- exact_screen_title: Insights - Runtime Ping Converter Rootfix
